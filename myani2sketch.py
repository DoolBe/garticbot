...
def get_transform(load_size=LOADSIZE):
    transform_list = []
    if load_size > 0:
        osize = [load_size, load_size]
        transform_list.append(transforms.Resize(osize, bic))
...
def ani2sketch(img):
    ...
    return Image.fromarray(aus_img).resize(aus_resize, Image.BICUBIC)


# In[3]:


#dataroot = "C:/Users/shouk/Desktop/karuta/sketch/1.jpg"
#img = Image.open(dataroot).convert('RGB')
#ani2sketch(img)
